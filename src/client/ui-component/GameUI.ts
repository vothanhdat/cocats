...
class UI extends UIElement {
    constructor(option: Option) {
        ...
        var but = this.childElement.but as BubbleButton

        but.onClick = this.popup.bind(this)

        setTimeout(this.popup.bind(this), 1000)
    }

    popup() {
        this.childElement.popup ||  this.addElement(new Popup(assets.BOY, [0.5, 0, '65%', 'auto', 0.5, 0.5], {
